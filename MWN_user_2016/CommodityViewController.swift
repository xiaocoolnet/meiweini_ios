...
class CommodityViewController: UIViewController,UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout {
    ...
    func createCollectionView() {
        ...
        collectionView = UICollectionView(frame: CGRectMake(0, 0, WIDTH, HEIGHT-200), collectionViewLayout: flowlayout)
