...
class WithdrawMoneyViewController: UIViewController,UITableViewDelegate,UITableViewDataSource {

    var myTableView = UITableView()
    let titArr:[String] = ["提现到尾号1223的银行卡","提现到支付宝"]
