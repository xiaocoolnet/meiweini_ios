...
class GengduoViewController: UIViewController {
    ...
    let fiveView = ChildrenViewController()
    let sixView = ChildrenViewController()
    ...
    override func viewDidLoad() {
        ...
        fiveView.title = nameArr[4]
        sixView.title = nameArr[5]
        let viewControllers = [oneView,twoView,threeView,fourView,fiveView,sixView]
